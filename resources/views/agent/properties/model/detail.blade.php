            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        ...
                        <div class="col col-md-10">
                            <input type="number" class="form-control" name="price" id="price" value="{{ $property->price }}">
                        </div>
                    </div>
               ...
               <div class="form-group row">
                    <div class="col">
                        ...
                        <div class="col col-md-10">
                            <input type="number" class="form-control" name="room_count" id="room_count" value="{{ $property->room_count }}">
                        </div>
                    </div>
                    <div class="col">
                        <label class="col col col-form-label">Bathrooms</label>
                        <div class="col col-md-10">
                            <input type="number" class="form-control" name="bath_count" id="bath_count" value="{{ $property->bath_count }}">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        ...
                        <div class="col col-md-10">
                            <input type="text" class="form-control" name="address1" id="address1" value="{{ $property->address2 }}">
                        </div>
                    </div>
